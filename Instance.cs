    ...
    public static partial class Instance
    {
        private static readonly Lazy<ILogListService> DefaultLogListService =
           new Lazy<ILogListService>(() =>
           {
               ...
               //var logListApi = new AppleLogListApi();
               var logListApi = new LogListApi("https://www.gstatic.com/ct/log_list/v2/log_list.json", "https://www.gstatic.com/ct/log_list/v2/log_list.sig", "https://www.gstatic.com/ct/log_list/v2/log_list_pubkey.pem");
               //var logListApi = new LogListApi("https://valid.apple.com/ct/log_list/current_log_list.json");
