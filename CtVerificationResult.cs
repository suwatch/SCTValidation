...
namespace Cats.CertificateTransparency.Models
{
    public class CtVerificationResult
    {
        ...
        //public string Description => switch (Result)
        //{
        //    case CtResult.DisabledForHost: return "Success: SCT disabled for host";
        //    case CtResult.Trusted => "Success: SCT trusted logs",
        //    case CtResult.InsecureConnection => "Success: SCT not enabled for insecure connection",
        //    case CtResult.NoCertificates => "Failure: No certificates",
        //    case CtResult.LogServersFailed => "Failure: Unable to load log servers",
        //    case CtResult.NoScts => "Failure: Certificate does not have any SCTs",
        //    case CtResult.TooFewSctsTrusted => "Failure: Certificate does not have any SCTs",
        //    case CtResult.FailedWithException => "Failure: Too few trusted SCTs",
